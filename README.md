...
![release](https://img.shields.io/badge/release-v0.4.2-2d6a4f) ![handbook](https://img.shields.io/badge/handbook-Approved-2d6a4f)
...
1. Referenciar este repo (submodule en `.sdaf/` pinneado a tag `v0.4.2` recomendado; subtree o copia también documentados).
...
`sdaf.version` en el YAML nombra la línea de constitución: `0.4.0` con pin `v0.4.2`, `v0.4.1` o `v0.4.0`, `0.3.0` con pin `v0.3.3`. No existe el tag `v0.3.0`. Quien se quede en `v0.3.3` o `v0.2.1` no está obligado.
