...
| `review/` | [code-review](review/code-review.md), [architecture-review](review/architecture-review.md), [specification-review](review/specification-review.md) | Approved |
| `quality/` | [quality-gates](quality/quality-gates.md), [testing-strategy](quality/testing-strategy.md) | Approved |
| `planning/` | [sprint-planning](planning/sprint-planning.md), [backlog-refinement](planning/backlog-refinement.md), [roadmap-planning](planning/roadmap-planning.md) | Approved |

Citar `ID@version` en worklogs.
...
| [H10](../handbook/10-code-review-and-quality-gates.md) | Prompts review/quality |
